...
if (contatoForm) {
    contatoForm.addEventListener('submit', (e) => {
        ...
        if (!nome || !mensagem) {
            ...
            formMessage.style.background = '#dc2626';
            formMessage.style.color = 'white';
            formMessage.style.padding = '1rem';
            formMessage.style.borderRadius = '8px';
            formMessage.style.marginBottom = '1rem';
            formMessage.textContent = 'Preencha nome e mensagem para continuar.';
            return;
        }
        
        // Formata a mensagem para o WhatsApp
        let mensagemWhatsApp = `*Olá - Vim pelo site! / pestalozziarcoverde.com.br*\n\n`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Garante renderizacao dos embeds do Instagram quando houver links incorporados.
